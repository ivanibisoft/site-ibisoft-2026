        ...
        <div className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-slate-200 mb-8">
          <div className="flex items-center gap-2 mb-6 pb-4 border-b border-slate-100">
            ...
            <h2 className="text-lg font-bold text-slate-900">
              Informações Cadastrais Oficiais da Empresa
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-slate-50/70 p-4 rounded-xl border border-slate-100">
              ...
              <p className="text-base font-bold text-slate-900 font-mono">{CNPJ_NUMBER}</p>
              <span className="text-xs text-slate-500 mt-1 block">Matriz</span>
            </div>
            ...
            <div className="bg-slate-50/70 p-4 rounded-xl border border-slate-100">
              ...
              <span className="text-xs text-slate-500 mt-1 block">Porte: EPP</span>
            </div>
            ...
            <div className="bg-slate-50/70 p-4 rounded-xl border border-slate-100">
              <span className="text-xs font-semibold uppercase tracking-wider text-slate-500 block mb-1 flex items-center gap-1">
                <UserCheck className="h-3.5 w-3.5 text-primary" /> Quadro Societário (QSA)
              </span>
              <p className="text-base font-bold text-slate-900">Ivan Christofolli</p>
            ...
            <div className="bg-slate-50/70 p-4 rounded-xl border border-slate-100">
              <span className="text-xs font-semibold uppercase tracking-wider text-slate-500 block mb-1 flex items-center gap-1">
                <Calendar className="h-3.5 w-3.5 text-primary" /> Fundação e Atividade
              </span>
              <p className="text-base font-bold text-slate-900">Desde 1985</p>
              <span className="text-xs text-slate-500 mt-1 block">
                Mais de 40 anos de excelência em TI e ERP
              </span>
            </div>

            <div className="bg-slate-50/70 p-4 rounded-xl border border-slate-100">
              <span className="text-xs font-semibold uppercase tracking-wider text-slate-500 block mb-1 flex items-center gap-1">
                <MapPin className="h-3.5 w-3.5 text-primary" /> Sede / Domicílio Fiscal
              </span>
              <p className="text-sm font-semibold text-slate-900">Curitiba / PR • Bairro Cabral</p>
              <span className="text-xs text-slate-500 mt-1 block">
